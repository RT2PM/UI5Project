...
function block0(context, tags, suffix) { return html `<div class="ui5-tli-root" dir="${ifDefined(this.effectiveDir)}"><div class="${classMap(this.classes.indicator)}"><div class="ui5-tli-icon-outer">${this.icon ? block1.call(this, context, tags, suffix) : block2.call(this, context, tags, suffix)}</div></div><div class="ui5-tli-bubble" tabindex="${ifDefined(this._tabIndex)}" data-sap-focus-ref><div class="ui5-tli-title">${this.name ? block3.call(this, context, tags, suffix) : undefined}<span>${ifDefined(this.titleText)}</span></div><div class="ui5-tli-subtitle">${ifDefined(this.subtitleText)}</div>${this.textContent ? block6.call(this, context, tags, suffix) : undefined}<span class="${classMap(this.classes.bubbleArrowPosition)}"></span></div></div>`; }
