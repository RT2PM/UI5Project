 ...
 */
const StandardListItem = withWebComponent('ui5-li', ['accessibleName', 'additionalText', 'additionalTextState', 'description', 'icon', 'image', 'type'], ['iconEnd', 'navigated', 'selected'], ['imageContent', 'deleteButton'], ['detail-click']);
