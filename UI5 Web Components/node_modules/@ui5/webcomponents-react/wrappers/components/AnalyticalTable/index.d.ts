...
import type { AnalyticalTableScrollMode, TableScaleWidthMode, TableSelectionBehavior, TableSelectionMode, TableVisibleRowCountMode, TextAlign, ValueState, VerticalAlign } from '../../enums/index.js';
import { AnalyticalTableScaleWidthMode, AnalyticalTableSelectionBehavior, AnalyticalTableSelectionMode, AnalyticalTableVisibleRowCountMode, AnalyticalTableSubComponentsBehavior } from '../../enums/index.js';
...
export interface AnalyticalTableColumnDefinition {
     ...
     */
    aggregateValue?: string | ((values: any, row: any, column: any) => any);
    /**
     ...
     * * `alphanumeric`
     */
    sortType?: string | ((rowA: any, rowB: any, columnId: string, descending: boolean) => any);
    /**
...
export interface AnalyticalTablePropTypes extends Omit<CommonProps, 'title'> {
     ...
     */
    visibleRowCountMode?: AnalyticalTableVisibleRowCountMode | keyof typeof AnalyticalTableVisibleRowCountMode | TableVisibleRowCountMode;
    /**
     ...
     * __Default:__ `"Row"`
     */
    selectionBehavior?: AnalyticalTableSelectionBehavior | keyof typeof AnalyticalTableSelectionBehavior | TableSelectionBehavior;
    /**
 ...
 */
declare const AnalyticalTable: React.ForwardRefExoticComponent<AnalyticalTablePropTypes & React.RefAttributes<AnalyticalTableDomRef>>;
