...
import { debounce, deprecationNotice, enrichEventWithDetails, useI18nBundle, useIsomorphicId, useIsomorphicLayoutEffect, useIsRTL } from '@ui5/webcomponents-react-base';
...
import { AnalyticalTableScaleWidthMode, AnalyticalTableSelectionBehavior, AnalyticalTableSelectionMode, AnalyticalTableVisibleRowCountMode, AnalyticalTableSubComponentsBehavior, GlobalStyleClasses } from '../../enums/index.js';
import { COLLAPSE_NODE, COLLAPSE_PRESS_SPACE, EXPAND_NODE, EXPAND_PRESS_SPACE, FILTERED, GROUPED, INVALID_TABLE, SELECT_PRESS_SPACE, UNSELECT_PRESS_SPACE, SELECT_ALL, DESELECT_ALL } from '../../i18n/i18n-defaults.js';
...
const AnalyticalTable = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const includeSubCompRowHeight = !!renderRowSubComponent && subComponentsBehavior === AnalyticalTableSubComponentsBehavior.IncludeHeight && !!tableState.subComponentsHeight && !!Object.keys(tableState.subComponentsHeight);
  ...
  }, [internalRowHeight, rows.length, internalVisibleRowCount, minRows, popInRowHeight, visibleRowCountMode, tableState?.interactiveRowsHavePopIn, adjustTableHeightOnPopIn, includeSubCompRowHeight, tableState.subComponentsHeight]);
