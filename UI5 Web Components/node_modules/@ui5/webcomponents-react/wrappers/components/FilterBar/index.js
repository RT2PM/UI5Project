...
import { ADAPT_FILTERS, CLEAR, FILTERS, GO, HIDE_FILTER_BAR, RESTORE, SEARCH, SHOW_FILTER_BAR } from '../../i18n/i18n-defaults.js';
...
const FilterBar = /*#__PURE__*/forwardRef((props, ref) => {
      ...
      if ( /*#__PURE__*/isValidElement(item)) {
        ...
        setToggledFilters(prev => {
          ...
          if (item.props.hasOwnProperty('visibleInFilterBar')) {
            return {
              ...prev,
              [key]: item.props.visibleInFilterBar
            };
          }
          return prev;
        });
  ...
  const renderChildren = () => {
    ...
    return safeChildren().filter(item => {
      ...
      //Selectable
      Array.isArray(child.props.children?.props?.children) && child.props.children?.props?.children?.map(item => item.props.selected).join(',') !== prevChildren?.current?.[key]?.children?.map(item => item.props.selected).join(','))) {
  ...
  }, header, hasButtons && /*#__PURE__*/React.createElement(ToolbarSpacer, null), ToolbarButtons), mountFilters && /*#__PURE__*/React.createElement("div", {
    className: filterAreaClasses,
    style: {
      position: 'relative'
    },
    ref: filterAreaRef
  }, search && /*#__PURE__*/React.createElement(FilterGroupItem, {
    "data-in-fb": true,
