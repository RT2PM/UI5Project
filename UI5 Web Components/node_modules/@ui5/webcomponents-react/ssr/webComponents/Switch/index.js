 ...
 */
const Switch = withWebComponent('ui5-switch', ['accessibleName', 'accessibleNameRef', 'design', 'name', 'textOff', 'textOn', 'tooltip'], ['checked', 'disabled', 'required'], [], ['change'], () => import('@ui5/webcomponents/dist/Switch.js'));
