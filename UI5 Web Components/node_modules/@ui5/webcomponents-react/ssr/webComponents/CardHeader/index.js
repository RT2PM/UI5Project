 ...
 */
const CardHeader = withWebComponent('ui5-card-header', ['status', 'subtitleText', 'titleText'], ['interactive'], ['action', 'avatar'], ['click'], () => import('@ui5/webcomponents/dist/CardHeader.js'));
