 ...
 */
const Avatar = withWebComponent('ui5-avatar', ['accessibleName', 'colorScheme', 'fallbackIcon', 'icon', 'initials', 'shape', 'size'], ['disabled', 'interactive'], ['badge'], [], () => import('@ui5/webcomponents/dist/Avatar.js'));
