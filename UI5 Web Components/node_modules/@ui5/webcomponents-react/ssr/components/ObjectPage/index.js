...
const ObjectPage = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const scrollToSection = useCallback(sectionId => {
    ...
    if (firstSectionId === sectionId) {
      ...
      if (!isNaN(childOffset)) {
        ...
        objectPageRef.current?.scrollTo({
          top: childOffset - safeTopHeaderHeight - anchorBarHeight - TAB_CONTAINER_HEADER_HEIGHT /*tabBar*/ - (headerPinned ? headerCollapsed === true ? 0 : headerContentHeight : 0),
          behavior: 'smooth'
        });
      }
    }
  ...
  useEffect(() => {
    if (selectedSubSectionId && isProgrammaticallyScrolled.current === true) {
      ...
      if (!isNaN(childOffset)) {
        ...
        objectPageRef.current?.scrollTo({
          top: childOffset - topHeaderHeight - anchorBarHeight - TAB_CONTAINER_HEADER_HEIGHT /*tabBar*/ - (headerPinned ? headerContentHeight : 0) - 16,
          behavior: 'smooth'
        });
      }
      isProgrammaticallyScrolled.current = false;
  ...
  useEffect(() => {
    ...
    const observer = new ResizeObserver(([sectionElement]) => {
      ...
      if (lastSubSection) {
        heightDiff += objectPage.getBoundingClientRect().height - topHeaderHeight - TAB_CONTAINER_HEADER_HEIGHT /*tabBar*/ - (!headerCollapsed ? headerContentHeight : 0) - lastSubSection.getBoundingClientRect().height - 32;
      }
      // heightDiff - footer - tabbar
      setSpacerBottomHeight(footer ? `calc(${heightDiff}px - 1rem - ${TAB_CONTAINER_HEADER_HEIGHT}px)` : `${heightDiff}px`);
    });
  ...
  useEffect(() => {
    ...
    if (isAfterScroll) {
      ...
      for (let i = 0; i <= sections.length - 1; i++) {
        ...
        if (objectPageRef.current.getBoundingClientRect().top + totalHeaderHeight + TAB_CONTAINER_HEADER_HEIGHT <= section.getBoundingClientRect().bottom) {
  ...
  const renderHeaderContentSection = useCallback(() => {
    if (headerContent?.props) {
      return /*#__PURE__*/cloneElement(headerContent, {
        ...
        }, avatar, (headerContent.props.children || titleInHeader) && /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement(DynamicPageHeader, {
  ...
  }, [headerContent, topHeaderHeight, headerPinned, scrolledHeaderExpanded, titleInHeader, avatar, headerContentRef, renderTitleSection]);
  ...
  }), headerTitle && renderTitleSection(), snappedHeaderInObjPage && /*#__PURE__*/React.createElement("div", {
    className: classes.snappedContent,
    "data-component-name": "ATwithImageSnappedContentContainer"
  }, headerTitle.props.snappedContent)), renderHeaderContentSection(), headerContent && headerTitle && /*#__PURE__*/React.createElement("div", {
