...
import { BarDesign, ButtonDesign, FlexBoxDirection, FlexBoxJustifyContent, TableMode, TitleLevel, ToolbarStyle } from '../../enums/index.js';
import { ACTIVE, ALL, BASIC, CANCEL, FIELD, FIELDS_BY_ATTRIBUTE, FILTERS, GROUP_VIEW, HIDE_VALUES, LIST_VIEW, MANDATORY, OK, RESET, SEARCH_FOR_FILTERS, SHOW_VALUES, VISIBLE, VISIBLE_AND_ACTIVE } from '../../i18n/i18n-defaults.js';
import { addCustomCSSWithScoping } from '../../internal/addCustomCSSWithScoping.js';
import { useCanRenderPortal } from '../../internal/ssr.js';
import { stopPropagation } from '../../internal/stopPropagation.js';
import { Bar, Button, Dialog, Icon, Input, Option, Panel, SegmentedButton, SegmentedButtonItem, Select, Table, TableColumn, Title } from '../../webComponents/index.js';
...
export const FilterDialog = props => {
  ...
  return /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(Dialog, {
    ...
    header: /*#__PURE__*/React.createElement(Bar, {
      design: BarDesign.Header,
      startContent: /*#__PURE__*/React.createElement(Title, {
        level: TitleLevel.H4,
        title: filtersTitle
      }, filtersTitle),
      endContent: showRestoreButton && /*#__PURE__*/React.createElement(Button, {
    ...
    "data-id": "all"
  }, allText), /*#__PURE__*/React.createElement(Option, {
    selected: filteredAttribute === 'visible',
    "data-id": "visible"
  }, visibleText), /*#__PURE__*/React.createElement(Option, {
    selected: filteredAttribute === 'active',
    "data-id": "active"
  }, activeText), /*#__PURE__*/React.createElement(Option, {
    selected: filteredAttribute === 'visibleAndActive',
    "data-id": "visibleAndActive"
  }, visibleAndActiveText), /*#__PURE__*/React.createElement(Option, {
    selected: filteredAttribute === 'mandatory',
    "data-id": "mandatory"
  }, mandatoryText)), /*#__PURE__*/React.createElement(ToolbarSpacer, null), /*#__PURE__*/React.createElement(Button, {
    design: ButtonDesign.Transparent,
    onClick: toggleValues,
    "aria-live": "polite"
  }, showValues ? hideValuesText : showValuesText), /*#__PURE__*/React.createElement(SegmentedButton, {
    ...
    mode: TableMode.MultiSelect,
    onSelectionChange: handleCheckBoxChange,
    columns: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TableColumn, null, fieldText), !showValues && /*#__PURE__*/React.createElement(TableColumn, {
      className: classes.tHactive
    }, activeText))
  }, isListView && renderChildren()), !isListView && renderGroups()), portalContainer ?? document.body);
};