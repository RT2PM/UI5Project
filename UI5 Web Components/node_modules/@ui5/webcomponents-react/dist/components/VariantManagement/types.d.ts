...
import type { ButtonPropTypes, DialogPropTypes, InputDomRef, ListDomRef, ResponsivePopoverPropTypes, TitlePropTypes } from '../../webComponents/index.js';
...
export interface VariantManagementPropTypes extends Omit<CommonProps, 'onSelect'> {
     ...
     */
    onSelect?: (event: Ui5CustomEvent<ListDomRef, ListSelectionChangeEventDetail & {
     ...
     */
    onSaveAs?: (e: Parameters<NonNullable<ButtonPropTypes['onClick']>>[0] & {
     ...
     * __Note:__ Calling `event.preventDefault()` prevents the dialog from closing when clicked.
     */
    onSaveManageViews?: (e: Parameters<NonNullable<ButtonPropTypes['onClick']>>[0] & {
        detail: {
     ...
     */
    onSave?: (e: Parameters<NonNullable<ButtonPropTypes['onClick']>>[0] & {
        detail: SelectedVariant;
    }) => void;
    /**
     * The event is fired when the "Cancel" button inside the Manage Views dialog is clicked or ESCAPE is pressed.
     */
    onManageViewsCancel?: (e: (Parameters<NonNullable<ButtonPropTypes['onClick']>>[0] | Parameters<NonNullable<DialogPropTypes['onBeforeClose']>>[0]) & {
        detail: {
     ...
     */
    onSaveViewCancel?: (e: (Parameters<NonNullable<ButtonPropTypes['onClick']>>[0] | Parameters<NonNullable<DialogPropTypes['onBeforeClose']>>[0]) & {
        detail: SelectedVariant;
