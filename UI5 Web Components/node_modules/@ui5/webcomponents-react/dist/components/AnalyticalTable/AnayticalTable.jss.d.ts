declare const styles: {
    ...
    tableHeaderBackgroundElement: {
        ...
        height: import("@ui5/webcomponents-react-base").CssSizeVariablesNames;
        backgroundColor: string;
        borderBlockStart: import("../../themes/CustomVariables.js").CustomVariables;
    ...
    th: {
        ...
        '&:hover': {
            backgroundColor: string;
            color: import("../../themes/CustomVariables.js").CustomVariables;
        };
        '&:active': {
            backgroundColor: string;
            color: import("../../themes/CustomVariables.js").CustomVariables;
    ...
    tableGroupHeader: {
        '&$tr': {
            fontFamily: import("../../themes/CustomVariables.js").CustomVariables;
            backgroundColor: string;
            border: string;
            color: string;
            '& $tableCell': {
    ...
    tableCell: {
        ...
        '&:last-child': {
            borderInlineEnd: import("../../themes/CustomVariables.js").CustomVariables;
        };
        overflow: string;
        textOverflow: string;
        whiteSpace: string;
