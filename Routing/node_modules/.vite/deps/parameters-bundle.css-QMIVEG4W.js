...
var _ = { packageName: "@ui5/webcomponents", fileName: "themes/sap_belize/parameters-bundle.css", content: `:root [_ui5host] {
...
:root [_ui5host] {
	...
	--_ui5_daypicker_item_now_border_focus_after: 0.0625rem dotted var(--sapContent_FocusColor);
...
:root [_ui5host] {
	...
	--_ui5_input_information_icon_padding: .625rem .5rem .625rem .5625rem;
	--_ui5-input-border: 1px solid var(--sapField_BorderColor);
	--_ui5_input_disabled_opacity: 0.5;
	--_ui5_input_error_warning_custom_icon_padding: .625rem;
	--_ui5_input_information_custom_icon_padding: .625rem;
...
:root [_ui5host] {
	...
	--_ui5_popup_header_background: var(--sapGroup_ContentBackground);
	--_ui5_popup_header_shadow: none;
	--_ui5_popup_header_border: 1px solid var(--sapGroup_ContentBorderColor);
}
:root [_ui5host] {
...
:root [_ui5host] {
	...
	--_ui5_tc_header_background: var( --sapObjectHeader_Background);
	--_ui5_tc_header_background_translucent: rgba(239,244,249,0.6);
	--_ui5_tc_content_background: var(--sapGroup_ContentBackground);
	--_ui5_tc_content_background_translucent: rgba(255,255,255,0.6);
}
:root [_ui5host] {
...
:root [_ui5host] {\r
	--__ui5_textarea_min_height: 2.5rem;\r
	--_ui5_textarea_padding_top: 0.5625rem;\r
	--_ui5_textarea_padding_bottom:0.5625rem;\r
	--_ui5_textarea_padding_top_readonly: 0.5625rem;\r
	--_ui5_textarea_padding_bottom_readonly:0.5625rem;\r
	--_ui5_textarea_padding_top_error_warning: 0.5rem;\r
	--_ui5_textarea_padding_bottom_error_warning: 0.5rem;\r
	--_ui5_textarea_padding_top_information: 0.5rem;\r
	--_ui5_textarea_padding_bottom_information: 0.5rem;\r
	--_ui5_textarea_padding_right_and_left: 0.6875rem;\r
	--_ui5_textarea_padding_right_and_left_error_warning: 0.625rem;\r
	--_ui5_textarea_padding_right_and_left_information: 0.625rem;\r
	--_ui5_textarea_padding_right_and_left_readonly: 0.6875rem;\r
}
...
.sapUiSizeCompact[_ui5host], .sapUiSizeCompact [_ui5host] {\r
	--__ui5_textarea_min_height: 1.625rem;\r
}
:root [_ui5host] {
...
:root [_ui5host] {
	--_ui5_tokenizer_padding: 0.375rem;
}
:root [_ui5host]{
...
:root [_ui5host] {
	...
	--_ui5_range_slider_handle_hover_background: rgba(217,217,217,0.6);
	--_ui5_slider_handle_top: -0.8725rem;
	--_ui5_slider_handle_margin_left: -1rem;
	--_ui5_slider_tickmark_color: var(--sapField_BorderColor);
...
:root [_ui5host] {
	/* SplitButton */
	--_ui5_split_button_middle_separator_height: 2.5rem;
	--_ui5_split_button_text_button_width: 2.5rem;
...
//# sourceMappingURL=parameters-bundle.css-QMIVEG4W.js.map
