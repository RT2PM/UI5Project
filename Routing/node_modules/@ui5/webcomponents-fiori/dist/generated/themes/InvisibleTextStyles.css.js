...
registerThemePropertiesLoader("@ui5/webcomponents-fiori", "sap_fiori_3", async () => defaultTheme);
const styleData = { packageName: "@ui5/webcomponents-fiori", fileName: "themes/InvisibleTextStyles.css", content: ".ui5-hidden-text {\n\tposition: absolute;\n\tclip: rect(1px,1px,1px,1px);\n\tuser-select: none;\n\tleft: -1000px; /* ensure the invisible texts are never part of the viewport */\n\ttop: -1000px;\n\tpointer-events: none;\n\tfont-size: 0;\n}" };
export default styleData;
//# sourceMappingURL=InvisibleTextStyles.css.js.map