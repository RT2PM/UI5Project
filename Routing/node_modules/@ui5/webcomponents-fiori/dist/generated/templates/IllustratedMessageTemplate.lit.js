...
function block3(context, tags, suffix) { return suffix ? html `<${scopeTag("ui5-title", tags, suffix)} level="H2" class="ui5-illustrated-message-title" wrapping-type="Normal">${ifDefined(this.effectiveTitleText)}</${scopeTag("ui5-title", tags, suffix)}>` : html `<ui5-title level="H2" class="ui5-illustrated-message-title" wrapping-type="Normal">${ifDefined(this.effectiveTitleText)}</ui5-title>`; }
