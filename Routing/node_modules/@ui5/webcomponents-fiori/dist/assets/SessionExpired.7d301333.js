import{r as C}from"./bundle.esm.9daf332c.js";const l=`<svg width="160" height="160" viewBox="0 0 160 160" id="tnt-Dialog-SessionExpired">
...
</svg>`,a=`<svg width="320" height="240" viewBox="0 0 320 240" id="tnt-Scene-SessionExpired">
...
</svg>`,s=`<svg width="128" height="128" viewBox="0 0 128 128" id="tnt-Spot-SessionExpired">
  ...
  <path fill="var(--sapIllus_Layering1)" d="M87.7097,95.5038 C85.4757,97.0988 81.4247,97.3158 78.9457,96.1378 L64.0567,85.8148 C63.9217,85.7418 63.7667,85.7388 63.6287,85.8058 L47.8457,96.0108 C46.5577,96.5888 41.8707,97.3978 40.1707,95.3358 C39.9187,97.9018 39.9017,100.6348 39.9017,103.7198 L87.9217,103.7198 C87.9557,100.7108 87.9487,98.0298 87.7097,95.5038" class="sapIllus_Layering1"/>
...
</svg>`,L="SessionExpired",r="tnt";C(L,{dialogSvg:l,sceneSvg:a,spotSvg:s,set:r});export{l as dialogSvg,a as sceneSvg,s as spotSvg};
