...
<head>
	...
	<title>Wizard Page Mode Test Page</title>
  ...
  <link rel="stylesheet" href="/assets/Wizard_test.c1970af5.css">
</head>
...
<body class="wizard_test1auto">
	...
	<script>
		...
		btnOpenDialog.addEventListener("click", () => {
			...
			setButtonVisibility(index, wiz2.children.length);
		});

		wiz2.addEventListener("ui5-step-change", event => {
			const index = wiz2.getSelectedStepIndex();
			setButtonVisibility(index, wiz2.children.length)
		});
