...
<head>
  ...
  <link rel="stylesheet" href="/assets/Wizard.dcc2dbcb.css">
</head>
...
<body class="wizard1auto">
	...
	<script>
		...
		wiz.addEventListener("ui5-step-change", function () {
		...
		sb.addEventListener("ui5-step-change", function () {
		...
		wiz2.addEventListener("ui5-step-change", function () {
			console.log(event.detail.step);
		});
		...
		sb2.addEventListener("ui5-step-change", function () {
