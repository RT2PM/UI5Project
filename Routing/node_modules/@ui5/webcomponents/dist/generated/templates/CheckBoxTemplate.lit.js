...
function block2(context, tags, suffix) { return suffix ? html `<${scopeTag("ui5-label", tags, suffix)} id="${ifDefined(this._id)}-label" class="ui5-checkbox-label" wrapping-type="${ifDefined(this.wrappingType)}">${ifDefined(this.text)}</${scopeTag("ui5-label", tags, suffix)}>` : html `<ui5-label id="${ifDefined(this._id)}-label" class="ui5-checkbox-label" wrapping-type="${ifDefined(this.wrappingType)}">${ifDefined(this.text)}</ui5-label>`; }
