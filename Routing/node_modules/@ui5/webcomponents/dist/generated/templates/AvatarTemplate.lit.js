...
function block0(context, tags, suffix) { return html `<div class="ui5-avatar-root" tabindex="${ifDefined(this.tabindex)}" data-sap-focus-ref @keyup=${this._onkeyup} @keydown=${this._onkeydown} @focusout=${this._onfocusout} @focusin=${this._onfocusin} @click=${this._onclick} role="${ifDefined(this._role)}" aria-haspopup="${ifDefined(this._ariaHasPopup)}" aria-label="${ifDefined(this.accessibleNameText)}">${this.hasImage ? block1.call(this, context, tags, suffix) : block2.call(this, context, tags, suffix)}<slot name="badge"></slot></div>`; }
...
function block4(context, tags, suffix) { return suffix ? html `<span class="ui5-avatar-initials">${ifDefined(this.validInitials)}</span><${scopeTag("ui5-icon", tags, suffix)} class="ui5-avatar-icon ui5-avatar-icon-fallback" name="employee"></${scopeTag("ui5-icon", tags, suffix)}>` : html `<span class="ui5-avatar-initials">${ifDefined(this.validInitials)}</span><ui5-icon class="ui5-avatar-icon ui5-avatar-icon-fallback" name="employee"></ui5-icon>`; }
