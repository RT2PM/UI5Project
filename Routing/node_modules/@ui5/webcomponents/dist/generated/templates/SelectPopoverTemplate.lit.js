...
function block0(context, tags, suffix) { return html `${this.options ? block1.call(this, context, tags, suffix) : undefined}${this.shouldOpenValueStateMessagePopover ? block13.call(this, context, tags, suffix) : undefined}`; }
function block1(context, tags, suffix) { return suffix ? html `<${scopeTag("ui5-responsive-popover", tags, suffix)} hide-arrow _disable-initial-focus placement-type="Bottom" class="ui5-select-popover ${classMap(this.classes.popover)}" horizontal-align="Left" @ui5-after-open="${ifDefined(this._afterOpen)}" @ui5-before-open="${ifDefined(this._beforeOpen)}" @ui5-after-close="${ifDefined(this._afterClose)}" @keydown="${this._onkeydown}" style=${styleMap(this.styles.responsivePopover)}>${this._isPhone ? block2.call(this, context, tags, suffix) : undefined}${!this._isPhone ? block7.call(this, context, tags, suffix) : undefined}<${scopeTag("ui5-list", tags, suffix)} mode="SingleSelectAuto" separators="None" @mousedown="${this._itemMousedown}" @ui5-item-click="${ifDefined(this._handleItemPress)}">${repeat(this._syncedOptions, (item, index) => item._id || index, (item, index) => block12.call(this, context, tags, suffix, item, index))}</${scopeTag("ui5-list", tags, suffix)}></${scopeTag("ui5-responsive-popover", tags, suffix)}>` : html `<ui5-responsive-popover hide-arrow _disable-initial-focus placement-type="Bottom" class="ui5-select-popover ${classMap(this.classes.popover)}" horizontal-align="Left" @ui5-after-open="${ifDefined(this._afterOpen)}" @ui5-before-open="${ifDefined(this._beforeOpen)}" @ui5-after-close="${ifDefined(this._afterClose)}" @keydown="${this._onkeydown}" style=${styleMap(this.styles.responsivePopover)}>${this._isPhone ? block2.call(this, context, tags, suffix) : undefined}${!this._isPhone ? block7.call(this, context, tags, suffix) : undefined}<ui5-list mode="SingleSelectAuto" separators="None" @mousedown="${this._itemMousedown}" @ui5-item-click="${ifDefined(this._handleItemPress)}">${repeat(this._syncedOptions, (item, index) => item._id || index, (item, index) => block12.call(this, context, tags, suffix, item, index))}</ui5-list></ui5-responsive-popover>`; }
function block2(context, tags, suffix) { return suffix ? html `<div class="ui5-responsive-popover-header"><div class="row"><span>${ifDefined(this._headerTitleText)}</span><${scopeTag("ui5-button", tags, suffix)} class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._toggleRespPopover}"></${scopeTag("ui5-button", tags, suffix)}></div>${this.hasValueStateText ? block3.call(this, context, tags, suffix) : undefined}</div>` : html `<div class="ui5-responsive-popover-header"><div class="row"><span>${ifDefined(this._headerTitleText)}</span><ui5-button class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._toggleRespPopover}"></ui5-button></div>${this.hasValueStateText ? block3.call(this, context, tags, suffix) : undefined}</div>`; }
