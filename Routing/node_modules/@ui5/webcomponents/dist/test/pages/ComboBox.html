...
<head>
  ...
  <script type="module" crossorigin src="/assets/test/pages/ComboBox.html.15d66df1.js"></script>
  <link rel="modulepreload" crossorigin href="/assets/bundle.common.798d47df.js">
  <link rel="stylesheet" href="/assets/ComboBox.de651845.css">
</head>
...
<body class="combobox1auto">
	...
	<div class="demo-section">
		...
		<ui5-combobox id="value-state-error" class="combobox2auto" value-state="Error">
			<ui5-cb-item text="Algeria"></ui5-cb-item>
			<ui5-cb-item text="Argentina"></ui5-cb-item>
			<ui5-cb-item text="Australia"></ui5-cb-item>
			<ui5-cb-item text="Austria"></ui5-cb-item>
	...
	<div class="demo-section">
		...
		<ui5-combobox class="combobox" readonly value-state="Error" id="readonly-value-state-cb">
			<ui5-cb-item text="Argentina"></ui5-cb-item>
			<ui5-cb-item text="United States of America"></ui5-cb-item>
			<ui5-cb-item text="Canada"></ui5-cb-item>
			<ui5-cb-item text="Germany"></ui5-cb-item>
