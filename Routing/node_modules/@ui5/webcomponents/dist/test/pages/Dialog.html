...
<head>
  ...
  <link rel="stylesheet" href="/assets/Dialog.be6e9063.css">
</head>
...
<body>
	...
	<div>
		...
		<ui5-dialog id="dialog-success-state" state="Success">
			<div slot="header">
				<ui5-title level="H1">Success</ui5-title>
			</div>
			<span>Hello World!</span>
		</ui5-dialog>
	...
	<div>
		...
		<ui5-dialog id="dialog-error-no-role" state="Error">
			<div slot="header">
				<ui5-title level="H1">Error</ui5-title>
			</div>
			<span>Hello World!</span>
		...
		<ui5-button id="btn-role-alert-success-state">Success State, 'AlertDialog' role set</ui5-button>
		<ui5-dialog id="dialog-success-state-alert-role" state="Success" accessible-role="AlertDialog">
			<div slot="header">
				<ui5-title level="H1">Success</ui5-title>
			</div>
			<span>Hello World!</span>
	...
	<div>
		...
		<ui5-list id="listContainerId" mode="SingleSelect">
			<ui5-li>Test1</ui5-li>
	...
	<script>
		...
		yes.addEventListener("click", function (event) {
			...
			window["confirm-dialog"].close();
			window["prevent-dialog"].close();
		});
		...
		window["resizable-custom-header-open"].addEventListener("click", function () { window["resizable-dialog-custom-header"].show(); });
		window["resizable-custom-header-close"].addEventListener("click", function () { window["resizable-dialog-custom-header"].close(); });
