...
<head>
  ...
  <link rel="stylesheet" href="/assets/List.4be08d9a.css">
</head>
...
<body class="list1auto">
	...
	<ui5-list id="listPrevent" mode="SingleSelect" header-text="Prevent selection change event">
	...
	<ui5-list id="myList5" mode="Delete" header-text="API: mode='Delete'">
