...
<head>
  ...
  <link rel="stylesheet" href="/assets/Input.38261f5b.css">
</head>
...
<body class="input1auto">
	...
	<ui5-input id="input3" value-state="Success" placeholder="Success state ..."></ui5-input>
	...
	<ui5-input id="input1" value-state="Warning" placeholder="Warning state ..."></ui5-input>
	...
	<ui5-input id="readonly-value-state-input" readonly value-state="Error"></ui5-input>
	...
	<ui5-input  value="input" value-state="Error"></ui5-input>
	...
	<script>
		...
		document.getElementById("myInput").addEventListener("ui5-suggestion-item-select", event => {
			const resultInput = document.getElementById("input-selection-event-test");
			resultInput.setAttribute("value", parseInt(resultInput.getAttribute("value") || 0) + 1);
		});
