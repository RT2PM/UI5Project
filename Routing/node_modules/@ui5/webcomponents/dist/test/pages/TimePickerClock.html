...
<head>
  ...
  <link rel="stylesheet" href="/assets/TimePickerClock.9c31b552.css">
</head>
<body>
	...
	<div>
		...
		<div class="clock-wrapper">
			<ui5-time-picker-clock id="myHours24" label="myHours24" item-min="1" item-max="12" display-step="1" selected-value="1" show-inner-circle prepend-zero support2400 last-item-replacement="24" active></ui5-time-picker-clock>
		</div>
		<div class="clock-wrapper">
			<ui5-time-picker-clock id="myHours00" label="myHours00" item-min="1" item-max="12" display-step="1" selected-value="1" show-inner-circle prepend-zero last-item-replacement="0" active></ui5-time-picker-clock>
		</div>
		<div class="clock-wrapper">
	...
	<script>
		...
		myHours00.addEventListener('ui5-change', displayChange);
