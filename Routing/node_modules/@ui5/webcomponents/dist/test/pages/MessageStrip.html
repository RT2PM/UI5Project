...
<head>
  ...
  <link rel="stylesheet" href="/assets/MessageStrip.c081bc94.css">
</head>
...
<body class="messagestrip1auto">
	...
	<ui5-message-strip class="top" design="Warning">Warning with default icon and close button:</ui5-message-strip>
    ...
    <ui5-message-strip design="Positive" class="top"><img src="/assets/loading.b2cd685f.gif" width="16" height="16" slot="icon">Custom icon</ui5-message-strip>
