...
<head>
  ...
  <link rel="stylesheet" href="/assets/Button.50012cf5.css">
</head>
...
<body class="button1auto">
	...
	<ui5-button icon="employee" icon-end accessible-name="Download book" class="button4auto">Action Bar Button</ui5-button>
