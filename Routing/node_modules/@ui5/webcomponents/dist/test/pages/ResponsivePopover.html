...
<head>
  ...
  <link rel="stylesheet" href="/assets/ResponsivePopover.0b11ba15.css">
</head>
...
<body class="responsivepopover2auto">
	...
	<script>
		...
		btnInitialFocus.addEventListener("click", function(event) {
			simpleRPInitialFocus.showAt(event.target, false);
		});
		...
		btnRoleAlert.addEventListener("click", function () {
			rPAlertRole.showAt(btnRoleAlert);
		});

		btnRoleNone.addEventListener("click", function () {
			rPNoneRole.showAt(btnRoleNone);
		});
