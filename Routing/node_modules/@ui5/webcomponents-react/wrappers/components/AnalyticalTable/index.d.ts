...
import type { AnalyticalTableScrollMode, TextAlign, ValueState, VerticalAlign, TableScaleWidthMode, TableSelectionMode, TableSelectionBehavior, TableVisibleRowCountMode } from '../../enums/index.js';
import { AnalyticalTableScaleWidthMode, AnalyticalTableSelectionBehavior, AnalyticalTableVisibleRowCountMode, AnalyticalTableSelectionMode } from '../../enums/index.js';
