 ...
 */
const TreeItem = withWebComponent('ui5-tree-item', ['additionalText', 'additionalTextState', 'text', 'accessibleName', 'icon', 'type'], ['expanded', 'hasChildren', 'indeterminate', 'navigated', 'selected'], ['deleteButton'], ['detail-click']);
