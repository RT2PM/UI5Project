 ...
 */
const Select = withWebComponent('ui5-select', ['accessibleName', 'accessibleNameRef', 'name', 'valueState'], ['disabled', 'required'], ['valueStateMessage'], ['change', 'close', 'open'], () => import('@ui5/webcomponents/dist/Select.js'));
