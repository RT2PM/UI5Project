 ...
 */
const Panel = withWebComponent('ui5-panel', ['accessibleName', 'accessibleRole', 'headerLevel', 'headerText'], ['collapsed', 'fixed', 'noAnimation', 'stickyHeader'], ['header'], ['toggle'], () => import('@ui5/webcomponents/dist/Panel.js'));
