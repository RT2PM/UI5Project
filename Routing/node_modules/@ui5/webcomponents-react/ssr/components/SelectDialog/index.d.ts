...
import type { ButtonDomRef, DialogDomRef, DialogPropTypes, IconDomRef, InputDomRef, ListDomRef, ListPropTypes, StandardListItemDomRef } from '../../webComponents/index.js';
export interface SelectDialogPropTypes extends Omit<DialogPropTypes, 'header' | 'headerText' | 'footer' | 'children'>, Pick<ListPropTypes, 'growing' | 'onLoadMore'> {
    /**
     ...
     */
    onSearchReset?: (event: Ui5CustomEvent<IconDomRef, {
        prevValue: string;
    }>) => void;
    /**
    ...
    onClear?: (event: Ui5CustomEvent<ButtonDomRef, {
        prevSelectedItems: StandardListItemDomRef[];
    }>) => void;
    /**
     ...
     */
    onConfirm?: ((event: Ui5CustomEvent<ListDomRef, {
        selectedItems: StandardListItemDomRef[];
    }>) => void) | ((event: Ui5CustomEvent<ButtonDomRef, {
        selectedItems: StandardListItemDomRef[];
    }>) => void);
}
/**
 ...
 */
declare const SelectDialog: React.ForwardRefExoticComponent<SelectDialogPropTypes & React.RefAttributes<DialogDomRef>>;
export { SelectDialog };
