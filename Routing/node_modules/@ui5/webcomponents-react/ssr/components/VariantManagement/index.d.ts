...
import type { ButtonPropTypes, ListDomRef, ResponsivePopoverPropTypes, TitlePropTypes } from '../../webComponents/index.js';
...
export interface VariantManagementPropTypes extends Omit<CommonProps, 'onSelect'> {
     ...
     */
    onSaveAs?: (e: Parameters<ButtonPropTypes['onClick']>[0] & {
     ...
     * __Note:__ Calling `event.preventDefault()` prevents the dialog from closing when clicked.
     */
    onSaveManageViews?: (e: Parameters<ButtonPropTypes['onClick']>[0] & {
        detail: {
     ...
     */
    onSave?: (e: Parameters<ButtonPropTypes['onClick']>[0] & {
        detail: SelectedVariant;
    }) => void;
}
/**
