export declare enum CssSizeVariablesNames {
 ...
 * @private
 */
export declare const CssSizeVariables: typeof CssSizeVariablesNames;
export declare const CozySizes: {
...
export declare const CompactSizes: {
    "--_ui5wcr-BarHeight": string;
    "--_ui5wcr-ButtonTopBottomPadding": string;
    "--_ui5wcr-AnalyticalTableExpandButtonHeight": string;
    "--_ui5wcr-AnalyticalTableExpandIconHeight": string;
